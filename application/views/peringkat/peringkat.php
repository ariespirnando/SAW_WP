<div class="page-content">
	<div class="row">
        ...
        <div class="page-header">
					<h1>
						Peringkat <?php echo $tahun?> <span class="btn-lg btn-primary" onclick="Tampil()">Tampilkan</span>
					</h1>
				</div>
         ...
         <div class="widget-body">
           <div class="widget-main no-padding">
              <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'Paris')">Perbandingan Algoritma</button> 
              </div>
              ...
              <div id="London" class="tabcontent">
                  ...
                  <table class="table table-striped table-bordered table-hover" width="100%">
                    <thead> 
                      <tr>
                        ...
                        <th width="60%" class="center">Nama Guru</th> 
                        ...
                        foreach ($result as $r) {
                          ?>
                            <tr>
                              ...
                              <td width="60%"><?php echo $r['vNama_guru']?></td> 
                ...
                <script type="text/javascript">
                   $.confirm({
                        title: 'Warning',
                        content: 'Anda Belum Melakukan Transaksi <b>Alternatif</b> periode <b><?php echo $tahun ?></b>',
                        type: 'red',
                        typeAnimated: true,
                        buttons: {
                            formSubmit: {
              ...
              <div id="Paris" class="tabcontent"> 
                  <?php $this->load->view('peringkat/perbandingan') ?>
              </div> 
